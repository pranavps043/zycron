...
const TerminalLabel = ({ children, className = "" }: { children: React.ReactNode; className?: string }) => (
  <div className={`flex items-center space-x-2 mb-2 ${className}`}>
    <div className="w-1 h-3 bg-brand-primary shadow-[0_0_8px_rgba(239,68,68,0.8)]" />
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            >
              <ScanLine />
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,rgba(239,68,68,0.05),transparent)] opacity-100" />
          ...
          <div className="lg:col-span-8 relative">
            ...
            <div className="relative bg-[#1a1a1a] p-1.5 md:p-3 rounded-[3rem] shadow-[0_40px_100px_rgba(0,0,0,0.8),inset_0_2px_10px_rgba(255,255,255,0.1)] border border-white/10">
                    ...
                    <div className="flex items-center space-x-6 font-mono">
                       <div className="flex flex-col items-end">
                         ...
                         <div className="flex gap-1 mt-1">
                            {[1,2,3,4,5].map(i => <div key={i} className={`w-1 h-2 ${i<5 ? 'bg-brand-primary shadow-[0_0_6px_#ef4444]' : 'bg-white/10'} rounded-sm`} />)}
                         </div>
                       </div>
                       <div className="flex flex-col items-end">
                  ...
                  <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="group relative">
                        ...
                        <div className="relative">
                          <input
                            type="text"
                            className="w-full bg-brand-primary/5 border border-brand-primary/20 rounded-xl px-5 py-4 text-white font-mono text-xs placeholder:text-white/20 focus:outline-none focus:border-brand-primary focus:bg-brand-primary/10 transition-all focus:ring-4 focus:ring-brand-primary/10 uppercase"
                    ...
                    <div className="group relative">
                      ...
                      <div className="relative">
                        <input
                          type="tel"
                          className="w-full bg-brand-primary/5 border border-brand-primary/20 rounded-xl px-5 py-4 text-white font-mono text-xs placeholder:text-white/20 focus:outline-none focus:border-brand-primary focus:bg-brand-primary/10 transition-all focus:ring-4 focus:ring-brand-primary/10 uppercase"
                          placeholder="[SECURE_VOICE_TAG]"
                        />
                      </div>
                    </div>

                    <div className="group">
                      <TerminalLabel>MESSAGE_BUFFER</TerminalLabel>
                      <textarea
                        className="w-full bg-brand-primary/5 border border-brand-primary/20 rounded-2xl px-5 py-4 text-white font-mono text-[11px] placeholder:text-white/20 focus:outline-none focus:border-brand-primary focus:bg-brand-primary/10 transition-all focus:ring-4 focus:ring-brand-primary/10 h-28 resize-none uppercase leading-relaxed"
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6">
                      <motion.button 
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="w-full md:w-2/3 bg-brand-primary/20 border border-brand-primary/50 text-brand-primary font-black py-5 rounded-2xl transition-all flex items-center justify-center space-x-5 shadow-[0_0_30px_rgba(239,68,68,0.2)] uppercase tracking-[0.5em] text-[10px] font-mono group hover:text-white"
                      >
                        <Send className="w-4 h-4 group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" />
                        <span>EXE_TRANSMISSION</span>
                      </motion.button>
              ...
              <div className="absolute top-1/2 -right-4 translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-4 z-50">
                ...
                <div className="w-3 h-3 rounded-full bg-brand-primary shadow-[0_0_10px_#ef4444] animate-pulse" />
              </div>
